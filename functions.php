...
function gently_scripts() {
    wp_enqueue_style( 'gently-style', get_stylesheet_uri() );

    wp_enqueue_script( 'gently-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20120206', true );

    wp_enqueue_script( 'gently-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20130115', true );
